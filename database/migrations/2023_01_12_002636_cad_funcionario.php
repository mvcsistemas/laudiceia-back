...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cad_funcionario', function (Blueprint $table) {
            $table->unsignedBigInteger('id_funcionario')->primary();
            $table->uuid('uuid');
            ...
            $table->index(['id_funcionario', 'uuid', 'nome_funcionario', 'cpf', 'cep', 'cidade', 'estado', 'acesso_sistema', 'ativo', 'id_departamento'], 'cad_funcionario_index');
        });
    }
